...
export default function Home() {
  ...
  const ArrayMobbiPhoto = [
    ...
    "/Project_Mobbi/MobbiProject2.png",
    "/Project_Mobbi/MobbiProject3.png",
    "/Project_Mobbi/MobbiProject4.png",
    "/Project_Mobbi/MobbiProject5.png",
    "/Project_Mobbi/MobbiProject6.png",
    "/Project_Mobbi/MobbiProject7.png",
    "/Project_Mobbi/MobbiProject8.png",
    "/Project_Mobbi/MobbiProject9.png",
  ];
    ...
    <main className="flex min-h-screen flex-col items-center justify-between pb-[2vw] px-[5vw]">
      <div className="section-aboutme max-w-full" id="Section-About-Me">
        ...
        <div className="flex flex-col justify-between items-center sm:flex-row">
          <div className="half-line relative sm:min-w-[800px] !justify-end sm:pr-[150px]">
            <div
              id="aksesoris"
              className=" hidden sm:flex flex-col items-end absolute top-[-30px] left-[120px]"
            >
              <div
                id="rounded-1"
                className="bg-red-200 rounded-[50%] h-4 w-4 mb-4 opacity-0"
              ></div>
              <div
                id="rounded-2"
                className="bg-red-400 rounded-[50%] h-6 w-6 my-4 mr-4 opacity-0"
              ></div>
              <div
                id="rounded-3"
                className="bg-red-600 rounded-[50%] h-8 w-8 my-4 mr-8 opacity-0"
              ></div>
              <div
                id="rounded-4"
                className="bg-red-800 rounded-[50%] h-12 w-12 my-4 mr-12 opacity-0"
              ></div>
              <div
                id="rounded-5"
                className="bg-red-800 rounded-[50%] h-12 w-12 my-4 mr-12 opacity-0"
              ...
              <div
                id="rounded-8"
                className="bg-red-200 rounded-[50%] h-4 w-4 mt-4 opacity-0"
              ></div>
            </div>
            <div className="relative flex items-center sm:mb-0 mb-16">
              ...
              <Image
                src={"/roundBorder.svg"}
                alt="round border image"
                width={100}
                height={100}
                priority
                className="absolute top-[-50px] sm:left-[-60px] left-[-45px] !max-w-[500px] sm:w-[500px] w-[450px] h-[500px]"
              ></Image>
            </div>
          </div>
          <div className="half-line flex-col font-cursive sm:min-w-[850px]">
      ...
      <div className="section-gallery flex flex-col items-center">
        <div className="title-section font-serif" id="Section-Project-Gallery">
          Project Gallery
        </div>
          ...
          >
            <div className="flex flex-col pt-4 pb-8 px-8 items-center relative bg-gray-400 text-white">
              ...
              <div className="grid grid-cols-3 gap-4">
                {(typeProject === "Olx" ? ArrayOLXPhoto : ArrayMobbiPhoto).map(
                  (photo) => (
                    <Image
                      src={photo}
                      alt="imageProject"
